...
if ($loguserid) {
  if ($isadmin) {
    $headlinks .= "<a href=\"".route('@admin')."\" style=\"font-style:italic;\">Admin</a> - ";
  }

  if ($power >= 1) {
    $headlinks .= "<a href='".route('@shop_editor')."' style=\"font-style:italic;\">Shop Editor</a> - ";
  }
...
if ($GLOBALS['jul_valid_db']) {
  ...
  $sql->query(
    'INSERT INTO dailystats (date, users, threads, posts, views) '.
