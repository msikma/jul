...
if (!is_file('config.php')) {
	early_html_die('Could not find a configuration file. Make sure you have a <tt>config.php</tt> file and it contains <tt>$sql_settings</tt> and <tt>$forum_settings</tt>. See <tt>config.example.php</tt>.');
}
...
if (!isset($sql_settings) || !isset($forum_settings)) {
	early_html_die('Your forum settings are not correct. Make sure you have a <tt>config.php</tt> file and it contains <tt>$sql_settings</tt> and <tt>$forum_settings</tt>. See <tt>config.example.php</tt>.');
}
