<?php
// Generates an image showing recent render times.
// Run with ?type=1 or ?type=2.
...
if ($_GET['type'] === '1' || !isset($_GET['type'])) {
	...
	$data_sql = "SELECT FLOOR(`time` / 3600) AS time, ".
	...
	$data   = $sql -> query($data_sql) or die(mysql_error());
