...
if($barwidth) $baron="<img src={$ui_images['bar_on']} width=$barwidth height=8>";
if($barwidth<$totalwidth) $baroff="<img src={$ui_images['bar_off']} width=".($totalwidth-$barwidth)." height=8>";
$bar="<img src={$ui_images['bar_left']}>$baron$baroff<img src={$ui_images['bar_right']}><br>";
...
$tccell1l><img src='{$GLOBALS['jul_views_path']}/ext/status.png?u=$id'>
$tblend
<br>$tblstart
